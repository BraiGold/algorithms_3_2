...
while getopts 'ha:' opt; do
  case $opt in
    ...
    h) echo ""
       echo "    Experimento 1 - Tiempo de ejecución variando cantidad de planetas"
       echo ""
...
for k in $n; do
  ...
  for h in $(seq 1 $iteraciones); do
    ...
    printf "%d\n " $h
    $(dirname $0)/../../../ElImperioContraataca < $(dirname $0)/grafoConexo-$k.txt -t >> $(dirname $0)/tiempos-exp1.txt
  done
